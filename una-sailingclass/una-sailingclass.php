...
// Set other options for Custom Post Type
	...
	$args = array(
		'label'               => __( 'sailing class', 'twentyseventeen-child' ),
...
class unawidgetsailingclass_widget extends WP_Widget {
	...
	public function widgetinside()
	{
       wp_reset_postdata();

		$queryArgs = array ('posts_per_page' => '1',
		                  'post_type' => 'sailingclass');
 
        $sailing_query = new WP_Query ($queryArgs);

		
		

		if ($sailing_query->have_posts())
		{
			while ($sailing_query->have_posts())
			{

			$sailing_query->the_post();
				?>
